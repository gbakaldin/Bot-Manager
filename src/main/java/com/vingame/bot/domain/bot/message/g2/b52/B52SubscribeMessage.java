...
@Getter
@Setter
public class B52SubscribeMessage extends SubscribeMessage implements HasCrowdBets {
    ...
    private B52EndGameMessage.LastJackpotData lJp;
    ...
    public B52SubscribeMessage(
            ...
            @JsonProperty("lJp") B52EndGameMessage.LastJackpotData lJp,
    ...
    @Getter
    @Setter
    public static class BetInfoWithTotal extends B52EndGameMessage.BetInfo {
        private long b;
