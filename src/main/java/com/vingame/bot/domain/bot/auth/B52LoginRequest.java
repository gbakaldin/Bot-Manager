...
public class B52LoginRequest implements LoginRequest {
    ...
    @JsonProperty("app_id")
    private final String appId = "bc114098";
    ...
    @JsonProperty("apVer")
    private final String apVer = "0.0.1197";

    private final String version = "0.0.1197";
