...
@Getter
@Setter
public class NohuSubscribeMessage extends SubscribeMessage implements HasCrowdBets {
    ...
    private NohuEndGameMessage.LastJackpotData lJp;
    ...
    public NohuSubscribeMessage(
            ...
            @JsonProperty("lJp") NohuEndGameMessage.LastJackpotData lJp,
     ...
     * {@code b} is carried into {@link CrowdOption#ownBet()} (D3, unused by v1).
     * Empty when no {@code bs}.
     */
    @Override
    ...
    @Getter
    @Setter
    public static class BetInfoWithTotal extends NohuEndGameMessage.BetInfo {
        private long b;
