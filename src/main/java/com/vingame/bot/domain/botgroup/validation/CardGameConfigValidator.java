...
/**
 * Permissive no-op validator for {@link GameType#CARD_GAME} groups (AD-5). This
 ...
 */
@Component
public class CardGameConfigValidator extends NoOpConfigValidator {

    @Override
    public GameType supportedType() {
        return GameType.CARD_GAME;
    }
}
