...
@Getter
@Setter
public class Subscribe extends Body implements CmdAwareMessage {
    private long mnB;
    private long tJpV;
    private boolean iab;
    private long tTU;
    ...
    private EndGameData.LastJackpotData lJp;
    ...
    public Subscribe(
            ...
            @JsonProperty("lJp") EndGameData.LastJackpotData lJp,
    ...
    @Getter
    @Setter
    public static class BetInfoWithTotal extends EndGameData.BetInfo {
        private long b;
    ...
    public static class PayoutRatio {
        ...
        public PayoutRatio(@JsonProperty("eid") int eid, @JsonProperty("v")  double v) {
            this.eid = eid;
            this.v = v;
        }
    }
